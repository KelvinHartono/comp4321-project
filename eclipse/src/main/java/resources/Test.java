	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		try {
			...
			for(HashMap<String, String> ret: retArr) {
				    ...
				    out.print("<p>Title: <a href='" + ret.get("url") + "'>" + ret.get("title") + "</a></p>");
				    out.print("<p>URL: <a href='" + ret.get("url") + "'>" + ret.get("url") + "</a></p>");
  ...
  <body>
    <div class='container'>
      ...
      <br />");
		    ...
		    out.print("<div class='content'>");
		    out.print("<div class='row'>");
		    out.print("<div class='col-1'><p>1.</p></div>");
		    out.print("<div class='col-1'><p>Score</p><p>1.0</p><p>PageRank</p><p>0.9</p><p>Title Sim</p><p>0.8</p><p>Cos Sim</p><p>0.7</p></div>");
		    out.print(" <div class='col-10'>");
		    out.print("<h6><a href='#'>page title</a></h6>");
		    out.print("<p><a href='#'>url</a></p>");
			out.print("<p>last modification date, size of page</p>");
            out.print("<p>keyword 1 freq 1; keyword 2 freq 2; keyword 3 freq 3; keyword 4 freq 4; keyword 5 freq 5;</p>");
            out.print("<p>Parent Links</p>");
            out.print("<p>Child Links</p>");
            out.print("</div></div></div><hr />");
